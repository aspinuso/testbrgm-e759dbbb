...
# =======================================================
NOTEBOOK_URL=http://epos-ics-d.brgm-rec.fr/swirrl/jupyter/c9396e1b-495d-457a-8681-0527a63e22e4
SERVICE_ID=c9396e1b-495d-457a-8681-0527a63e22e4
get_notebook http://swirrl-api/swirrl-api/v1.0/notebook e6ae5e1a-f3c4-41fd-8187-70735aaebf10 c9396e1b-495d-457a-8681-0527a63e22e4
mkdir -p ~/data/staginghistory/stage.00001
download ${NOTEBOOK_URL}/api/contents/data/staginghistory/stage.00001/filename3.seed ~/data/staginghistory/stage.00001/filename3.seed
download ${NOTEBOOK_URL}/api/contents/data/staginghistory/stage.00001/filename2.seed ~/data/staginghistory/stage.00001/filename2.seed
...
download ${NOTEBOOK_URL}/api/contents/data/staginghistory/stage.00001/filename1.xml ~/data/staginghistory/stage.00001/filename1.xml
